...
import AddForm from '../../../components/Attendance/PersonalLeave/ModalAddForm';
import EditFrom from '../../../components/Attendance/PersonalLeave/ModalEditForm';
import SearchForm from '../../../components/Attendance/PersonalLeave/SearchForm';

import { delPersonalLeave, pageList, getById } from '../../../services/personalLeave';
import styles from './PersonalLeave.less';
...
export default class PersonalLeave extends PureComponent {
  state = {
    data: [],
    staffAllList: [],
    holidayTypeList:[],
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
          <Fragment>
            {hasAccessKey('attendance.personalLeave.update') && (
            <a title="编辑" onClick={() => this.handleModalVisible(true, 1, record.rowId)}>
              <Icon type="edit" />
            </a>
            )}
            <Divider type="vertical" />
            {hasAccessKey('attendance.personalLeave.delete') && (
    ...
    return (
      hasAccessKey('attendance.personalLeave.list') && (
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              {hasAccessKey('attendance.personalLeave.add') && (
