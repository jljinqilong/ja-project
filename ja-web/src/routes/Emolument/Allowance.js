...
import AddForm from '../../components/Emolument/Allowance/ModalAddForm';
import EditForm from '../../components/Emolument/Allowance/ModalEditForm';
import SearchForm from '../../components/Emolument/Allowance/SearchForm';

import { baseList } from '../../services/org';
import { delAllowance, list, getById, beachDel, empty } from '../../services/eltAllowance';

import styles from './Allowance.less';

export default class Allowance extends PureComponent {
  state = {
    data: [],
    orgBaseList: [],
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title={this.state.title} t>
        <Card bordered={false}>
