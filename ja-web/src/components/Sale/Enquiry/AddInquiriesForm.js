...
// 询单详情
@Form.create()
export default class AddInquiriesForm extends PureComponent {
  constructor(props) {
    super(props);
        ...
        <Row gutter={24}>
          <Col span={24}>
            <FormItem label="BOM要求" labelCol={{ span: 4 }} wrapperCol={{ span: 20 }}>
              {getFieldDecorator('bomRequire')(<TextArea rows={4} placeholder="BOM要求" />)}
            </FormItem>
          </Col>
        </Row>
        <Row gutter={24}>
        ...
        <Row gutter={24}>
          <Col span={24}>
            <FormItem label="备注" labelCol={{ span: 4 }} wrapperCol={{ span: 20 }}>
              {getFieldDecorator('remark')(<TextArea rows={4} placeholder="备注信息" />)}
            </FormItem>
          </Col>
        </Row>
      </Form>
