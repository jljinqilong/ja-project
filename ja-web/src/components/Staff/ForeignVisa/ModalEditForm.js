...
import { getById, update } from '../../../services/foreignVisa';
...
class ModalEditForm extends PureComponent {
      ...
      getById(nextProps.currentEditUserId)
        .then(data => {
          this.setState({
            ...
            annualInspectionDate: data.data.annualInspectionDate,
            fileList: [],
          });
        })
        .catch(() => {
  ...
  handleSure = () => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      fieldsValue.endDate = this.state.endDat,
        ...
        <Form>
          ...
          <Form.Item labelCol={{ span: 7 }} wrapperCol={{ span: 15 }} label="年检时间">
            {getFieldDecorator('annualInspectionDate', {
              initialValue: moment(this.state.annualInspectionDate),
