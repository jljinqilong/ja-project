...
public class InquiriesForm extends BaseForm {
    ...
    //询单评审
    private Long inquiriesAppraisalId;
    ...
    public Long getInquiriesAppraisalId() {
        return inquiriesAppraisalId;
    }

    public void setInquiriesAppraisalId(Long inquiriesAppraisalId) {
        this.inquiriesAppraisalId = inquiriesAppraisalId;
    }
}