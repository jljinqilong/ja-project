...
public class OrgAndOrgInfo extends BaseBean {
	 ...
	 * 子组织个数
	 */
    private Integer sonOrgNum;
    
    
    public Integer getSonOrgNum() {
		return sonOrgNum;
	}

	public void setSonOrgNum(Integer sonOrgNum) {
		this.sonOrgNum = sonOrgNum;
	}
    ...
    public Long getTotalStaffNum() {
		return totalStaffNum;
	}

	public void setTotalStaffNum(Long totalStaffNum) {
